...
One of the interesting things about this approach is that your not limited to using OIDC just with cloud providers, you can use with your own services as well. By using OIDC libraries such as [github.com/coreos/go-oidc](https://github.com/coreos/go-oidc) you can implement APIs which can using the identity of CI pipelines, workflows, and jobs. An example of this is [Using OIDC With HashiCorp Vault and GitHub Actions](https://www.hashicorp.com/en/resources/using-oidc-with-hashicorp-vault-and-github-actions).
